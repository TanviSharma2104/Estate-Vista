          ...
          {/* leftside div */}
            ...
            <div className='flex flex-col flex-1 gap-4'>
              ...
              <div className="flex gap-4">
                ...
                <button type='button' onClick={handleImageSubmit} disabled={uploading} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-75'>{uploading? 'Uploading...' : 'Upload'}</button>
              </div>
              ...
              <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-90 disabled:opacity-75'> {loading? 'Creating...':'Create Listing'}</button>
